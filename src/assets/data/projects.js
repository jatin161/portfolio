...
const projects = [
  {
    ...
    desc:'The Movie Recommendation System is a data science project based on cosine similarity that suggests movies to users using machine learning techniques. It uses cosine similarity to measure the similarity between movies based on genre, cast, director, keywords, and overview to provide personalized recommendations.',
  ...
  },
  {
    ...
    // eslint-disable-next-line prettier/prettier
    desc:
    'This Python script utilizes the Selenium library to automate the process of logging into WhatsApp Web, crawling through a list of contacts, and converting DataFrame Summary into images & sending the images to requested contact/Group.',
    img: WhatsappImg,
  ...
  {
    id: uuidv4(),
    name: 'House Price Predictor (Ames Iowa)',
    // eslint-disable-next-line prettier/prettier
    desc:
    'The Iowa house prediction is a data science project uses regression as a base algorithm to predict house prices based on generic features like neighborhood, size of living area, etc.',
    img: HousePrice,
    path: 'https://jatin161-house-price-predictor-main-qc4mb3.streamlit.app/',
    target: '_blank',
  },
];
